  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-10 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row max-w-[1000px] w-full flex-1 gap-8 z-10">
          {/* Left Column: Login Form */}
          <div className="flex flex-col justify-center flex-1 max-w-[480px] w-full mx-auto md:mx-0">
            <div className="flex flex-col gap-6 p-2">
              ...
              <div className="flex items-center justify-center gap-2 mt-4 opacity-70">
                ...
                <p className="text-xs text-muted-foreground">End-to-end encrypted & Secure</p>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex flex-1 items-center justify-center">
            <div className="w-full h-full max-h-[600px] bg-card/50 rounded-xl border border-border backdrop-blur-sm relative overflow-hidden group">
              {/* Image Container */}
              <div
                className="w-full h-full bg-center bg-cover absolute inset-0 opacity-60 mix-blend-overlay"
                style={{
                  backgroundImage:
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-background via-background/50 to-transparent">
                ...
                <h3 className="text-foreground text-2xl font-bold mb-2">AI-Powered Privacy</h3>
                <p className="text-muted-foreground text-sm max-w-sm">
                  Our advanced algorithms automatically detect and remove silences and filler words
                  in your video footage with 100% local processing.
                </p>
              </div>
            </div>
          </div>
